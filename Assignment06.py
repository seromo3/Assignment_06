...
# SRomo, 2020-Aug-18, Added add_cd functions, remove_cd function
# SRomo, 2020-Aug-19, Added write to file function
#------------------------------------------#
...
while True:
    ...
    # 3.3 process add a CD
        ...
        DataProcessor.add_cd(intID, strTitle, strArtist)
        IO.show_inventory(lstTbl)
        continue  # start loop back at top.
